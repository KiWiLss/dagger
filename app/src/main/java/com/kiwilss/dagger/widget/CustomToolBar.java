...
/**-------------背景颜色------------*/
        ...
        /**-------------设置内容------------*/
        View barLayoutView = View.inflate(getContext(), R.layout.top, null);
        ...
        if (backgroundResId != -1) {
            barRlyt.setBackgroundResource(R.drawable.top_bg);
            //barRlyt.setBackground(getResources().getDrawable(R.drawable.topbg));
        }
